    ...
    <div class="row" style="margin-top: 20px">
        <div class="col-3">
            <div class="list-group">
                ...
                <button type="button" class="list-group-item list-group-item-action active" onclick="findByClass()"
                        aria-current="true">按班级查找学生
                </button>
...
<script>
    $("#findStu").submit(function () {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/student/findStudentsByClass",
            type: "post",
            data: {
